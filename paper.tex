...
All 37 PSLQ tests plus the LLL cross-validation and extended-search
suites are reported with full parameters; the entire LLL workload
(base suite, degree extension, and new-family sweep) runs in about
$11$ minutes.
...
degree-100 and degree-12 tests).  Every result reported in this paper
is generated by one of those three scripts.
