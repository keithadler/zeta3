...
$26$-plus-element tests.  A compiled LLL implementation such as
\texttt{fpylll} may scale better than mpmath's fixed-point PSLQ on
these larger bases; we leave this to future work.
\end{remark}
